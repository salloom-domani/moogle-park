        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            {groupMembers.map((member) => (
              <li key={member.id} className="flex items-center gap-3 p-1">
                <Image
          ...
          />
          <ul className="space-y-2 mt-2 max-h-32 overflow-scroll">
            {usersNotInGroup
              .filter((user) =>
              ...
              .map((user) => (
                <li
                  key={user.id}
                  className="flex items-center gap-3 hover:bg-muted p-1 rounded"
                >
                  <Image
